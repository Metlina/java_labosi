...
public class Casopis extends Publikacija implements ZaPosudbu, Serializable{
	 ...
	 */
	public Casopis(Integer id, Integer mjesecIzdavanjaCasopisa, Integer godinaIzdanjaPublikacije, Integer brojStranicaPublikacije,  VrstaPublikacije vrstaPublikacije, String nazivCasopisa) throws NeisplativoObjavljivanjeException
	{
		super(id, godinaIzdanjaPublikacije, brojStranicaPublikacije, vrstaPublikacije, CIJENA_PO_PRIMJERKU/brojStranicaPublikacije, nazivCasopisa);
