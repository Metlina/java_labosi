...
/**
 * Prestavlja klasu u kojoj se upisuju podatci i izvrsava program
 * 
 * @author Tino
 *
 */
public class Glavna {
	...
	/**
	 * Omogucuje upisivanje knjige
	 * 
	 * @return knjiga
	 * @throws NeisplativoObjavljivanjeException baca gresku ako je knjiga neisplativa
	 */
	...
	/**
	 * Omogucuje upisivanje casopisa
	 * 
	 * @return casopis
	 * @throws NeisplativoObjavljivanjeException baca gresku ako je casopis neisplativa
	 */
	...
	public static void main(String[] args) {
		...
		Knjiznica<Publikacija> sortinaraKnjiznica = new Knjiznica<>();
		...
		System.out.println("Publikacije za posuudbu : ");		
