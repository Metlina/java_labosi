...
public class Knjiga extends Publikacija implements ZaPosudbu, Serializable{
	 ...
	 */
	public Knjiga(Integer id, String nazivKnjige, Jezik jezikKnjige, Izdavac izdavacKnjige, Integer godinaIzdavanjaKnjige,  VrstaPublikacije vrstaPublikacije, double cijenaPoStraniciKnjige, Integer brojStranicaKnjige) throws NeisplativoObjavljivanjeException
	{
		super(id, godinaIzdavanjaKnjige, brojStranicaKnjige, vrstaPublikacije, cijenaPoStraniciKnjige, nazivKnjige);
		this.jezikKnjige = jezikKnjige;
		this.izdavacKnjige = izdavacKnjige;
		this.raspolozivost = true;
		
		if (super.getCijenaPublikacije().intValue() <= 10)
		{
